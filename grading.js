...
async function runQuickTest() {
    ...
    // Switch to grading mode safely (setMode may fail if expected elements don't exist)
    try {
        if (typeof setMode === 'function') setMode('grading');
    } catch (e) {
        console.log('🧪 setMode skipped (already in grading mode):', e.message);
    }
