...
`whatnot-valuator` **2.45.0 in the working tree 2026-09-15 (fix for the 2.44.0 false-fire), pending Mike's commit + reload; 2.44.0 (`d1d10dd`) is what is loaded until the reload shows 2.45.0**, `slab-guard-monitor` 1.0.1.
